...
// information from user using for loop-----> No : of Passengers.
//Create MEthods to display the User information
//To  create methods to comapare the source and destination using array list